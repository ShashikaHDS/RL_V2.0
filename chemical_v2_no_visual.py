...
class ChemicalClean(gym.Env):
    ...
    def step(self, actions):
        ...
        for i, action in enumerate(actions):
            ...
            total_allowed_steps = int(0.8 * (self.grid_size[0] * self.grid_size[1]))
...
models_dir = f"models/Chemical_spils_06_06_2025/{int(time.time())}/"
logdir = f"logs/Chemical_spils_06_06_2025/{int(time.time())}/"
